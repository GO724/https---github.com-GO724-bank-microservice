        ...
        "responses": {
          "200": {
            ...
            "schema": {
              "type": "array",
              "items": {
                "$ref": "#/definitions/GetBanksOKBodyItems0"
              }
            }
          },
          "400": {
        ...
        "responses": {
          "200": {
            ...
            "schema": {
              "type": "array",
              "items": {
                "$ref": "#/definitions/GetCardsOKBodyItems0"
              }
            }
          },
          "400": {
        ...
        "responses": {
          "200": {
            ...
            "schema": {
              "type": "array",
              "items": {
                "$ref": "#/definitions/GetPersonsOKBodyItems0"
              }
            }
          },
          "400": {
