...
type GetCardsOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*GetCardsOKBodyItems0 `json:"body,omitempty"`
}
...
func (o *GetCardsOK) WithPayload(payload []*GetCardsOKBodyItems0) *GetCardsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get cards o k response
func (o *GetCardsOK) SetPayload(payload []*GetCardsOKBodyItems0) {
	o.Payload = payload
}
...
func (o *GetCardsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*GetCardsOKBodyItems0, 0, 50)
	}
