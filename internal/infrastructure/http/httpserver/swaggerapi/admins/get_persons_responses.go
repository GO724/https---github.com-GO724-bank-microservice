...
type GetPersonsOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*GetPersonsOKBodyItems0 `json:"body,omitempty"`
}
...
func (o *GetPersonsOK) WithPayload(payload []*GetPersonsOKBodyItems0) *GetPersonsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get persons o k response
func (o *GetPersonsOK) SetPayload(payload []*GetPersonsOKBodyItems0) {
	o.Payload = payload
}
...
func (o *GetPersonsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*GetPersonsOKBodyItems0, 0, 50)
	}
