...
func makeClient(cmd *cobra.Command, _ []string) (*client.BcardMicroserviceAPI, error) {
...
func MakeRootCmd() (*cobra.Command, error) {
	...
	c0, err := makeGroupOfOperationsAdminsCmd()
	if err != nil {
		return nil, err
	}
...
} // makeGroupOfOperationsAdminsCmd returns a parent command to handle all operations with tag "admins"
func makeGroupOfOperationsAdminsCmd() (*cobra.Command, error) {
	parent := &cobra.Command{
		Use:  "admins",
		Long: ``,
	}

	sub0, err := makeOperationAdminsGetBanksCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub0)

	sub1, err := makeOperationAdminsGetCardsCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub1)

	sub2, err := makeOperationAdminsGetPersonsCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub2)

	sub3, err := makeOperationAdminsAddCardCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub3)

	sub4, err := makeOperationAdminsAddPersonCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub4)

	sub5, err := makeOperationAdminsAddbankCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub5)

	sub6, err := makeOperationAdminsDelBankCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub6)

	sub7, err := makeOperationAdminsDelPersonCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub7)

	sub8, err := makeOperationAdminsDelСardCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub8)

	sub9, err := makeOperationAdminsGetBankCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub9)

	sub10, err := makeOperationAdminsGetCardCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub10)

	sub11, err := makeOperationAdminsGetPersonCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub11)

	sub12, err := makeOperationAdminsIsValidCmd()
	if err != nil {
		return nil, err
	}
