...
func NewBcardMicroserviceAPIAPI(spec *loads.Document) *BcardMicroserviceAPIAPI {
	return &BcardMicroserviceAPIAPI{
		...
		AdminsAddPersonHandler: admins.AddPersonHandlerFunc(func(params admins.AddPersonParams) middleware.Responder {
			return middleware.NotImplemented("operation admins.AddPerson has not yet been implemented")
		}),
		AdminsAddbankHandler: admins.AddbankHandlerFunc(func(params admins.AddbankParams) middleware.Responder {
...
type BcardMicroserviceAPIAPI struct {
	...
	// AdminsAddPersonHandler sets the operation handler for the add person operation
	AdminsAddPersonHandler admins.AddPersonHandler
	// AdminsAddbankHandler sets the operation handler for the addbank operation
	AdminsAddbankHandler admins.AddbankHandler
...
func (o *BcardMicroserviceAPIAPI) Validate() error {
	...
	if o.AdminsAddPersonHandler == nil {
		unregistered = append(unregistered, "admins.AddPersonHandler")
	}
	if o.AdminsAddbankHandler == nil {
		unregistered = append(unregistered, "admins.AddbankHandler")
	}
...
func (o *BcardMicroserviceAPIAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/persons"] = admins.NewAddPerson(o.context, o.AdminsAddPersonHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/banks"] = admins.NewAddbank(o.context, o.AdminsAddbankHandler)
